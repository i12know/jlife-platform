...
Both are public domain in the US (published before 1930) and in Vietnam (author's life + 50 years). The later **Thomas & Gundry** *NIV Harmony of the Gospels* (1978) and *Harmony of the Gospels: NASB Edition* (1977) **kept the Broadus/Robertson arrangement unchanged** at the section level — same 184 sections, same numbers, same order — but paired it with the NIV/NASB text, added their own notes/essays, and **subdivided Robertson's longer sections with lettered suffixes** (e.g. Robertson's §8 becomes §8a/§8b/§8c in their editions). So the arrangement in modern use *is* the public-domain arrangement; what is copyrighted in Thomas & Gundry is the NIV/NASB text (Biblica/Zondervan and The Lockman Foundation respectively) and their own notes/essays, not the chronology. Chronological facts as such are not copyrightable anyway.
...
4. **Thomas & Gundry's lettered subsections (§8a/§8b/§8c-style splits) are usable the same way, without a rights conversation, if we independently determine our own split points.** A subdivision is just a further cut of an already-public-domain factual grouping — the same category of act as Robertson's own division of the Gospels into 184 sections in the first place (§3 above), which this repo already treats as free of any rights gate. If Robertson's original division needed no clearance, a second, finer division of it doesn't either; verse/chapter boundaries are themselves centuries-old public standard (versification traces to Robert Estienne, 1551), not anyone's property. What we may **not** do without clearance is copy Thomas & Gundry's own subsection *titles* or prose verbatim, or transcribe their book's specific split points as a scraped copy of their edition — reproducing their expression is different from independently choosing where a section naturally divides. In practice: pick split points from the public-domain scripture text itself (or a contributor's own reading of Robertson), don't lift them from a proprietary source.
5. Standard caveat: this is careful project-level analysis, not formal legal advice; if the platform grows, a proper review is cheap insurance.
